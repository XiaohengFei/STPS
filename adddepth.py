    ...
    def run(self, process_callback):
        ...
        try:
            while True:
                ...
                # 使用四通道 YOLOv8 模型进行预测
                results = self.model(frame_4ch, conf=0.5)  # 设置置信度阈值为50%
...
def main():
    ...
    model_path = os.path.abspath("E:\\Project\\STPS\\yolomodel\\best.pt")  # 确保加载训练好的四通道模型
